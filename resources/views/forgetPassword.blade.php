    ...
    <div class="mt-8">
        <form class="space-y-4" action="">
            <div class="w-full flex flex-col gap-1">
                ...
                <input type="email" required placeholder="Enter your registered email ....." class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[4px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
            </div>
            <div class="mt-2"></div>
            <a href="{{route('password_link_sent')}}" class="w-full mt-8 px-4 py-3 bg-primary/80 border-[2px] border-primary/90 text-white/80 font-semibold hover:bg-primary/90 hover:text-white rounded-[3px] inline-flex items-center justify-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 transition ease-in duration-200">
                Send Reset Link
      </a>
        </form>
        <div class="mt-4">
            <p class="text-center text-primary text-sm font-medium">
                Remember your password? <a href="/" class="text-secondary hover:text-danger transition ease-in duration-2000 font-semibold">
                    Back to Login 🔒
                </a>
            </p>
        </div>
