...
@endif
                      ...
                      <div class="bg-primary/10 px-4 py-2 border-b-[2px] border-b-primary/20 flex justify-between">
                          <span class="font-semibold text-primary text-xl">Update instrument </span>
                        </div>
          
          
          
                       <div id="formDiv" class="w-full border-b-[2px] border-b-ternary/10 shadow-lg shadow-ternary/20 ">
                       <form action="{{ route('superadmin.instrumentupdate_store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                              ...
                              <input type="hidden" name="instrument_id" value="{{$instruments->id ?? ''}}">
                              <input type="hidden" name="category_id" value="{{$instruments->category_type ?? ''}}">
                              <input type="hidden" name="lab_id" value="{{$instruments->lab_id ?? ''}}">
                               ...
                               <div class="w-full grid xl:grid-cols-4 gap-2 p-4 ">
                                  ...
                                  <div class="w-full flex flex-col gap-1">
                                    ...
                                    <input type="text" name="model_number" value="{{$instruments->model_number ?? ''}}"  required placeholder="Model number" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                ...
                                <div class="w-full flex flex-col gap-1">
                                  ...
                                  <input type="text" name="serial_number"  value="{{$instruments->serial_number ?? ''}}"  required placeholder="Serial number" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                ...
                                <div class="w-full flex flex-col gap-1">
                                  ...
                                  <input type="text" name="asset_id" value="{{$instruments->asset_id ?? ''}}" required placeholder="Asset ID" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                ...
                                <div class="w-full flex flex-col gap-1">
                                  ...
                                  <select name="operating_status" required   class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000">
                                      <option value="working" {{ old('operating_status', $instruments->operation_status ?? '') == 'working' ? 'checked' : '' }}>Working</option>
                                      <option value="under maintainance" {{ old('operating_status', $instruments->operation_status ?? '') == 'under maintainance' ? 'checked' : '' }}>Under Maintainance</option>
                                      <option value="out of order" {{ old('operating_status', $instruments->operation_status ?? '') == 'out of order' ? 'checked' : '' }}>Out of Order</option>
                                ...
                                <div class="w-full flex flex-col gap-1">
                                  ...
                                  <input type="number" name="perhourcost" value="{{$instruments->per_hour_cost ?? ''}}" required placeholder="Per hour cost" value="{{ old('perhourcost') }}" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                ...
                                <div class="w-full flex flex-col gap-1">
                                  ...
                                  <input type="number" name="minimumbookingduration" value="{{$instruments->minimum_booking_duration ?? ''}}"   required placeholder="Duration(Hours)" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                ...
                                <div class="w-full flex flex-col gap-1">
                                  ...
                                  <input type="number" name="maximum_booking_duration"  value="{{$instruments->maximum_booking_duration ?? ''}}"  required placeholder="Duration(Hours)" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                ...
                                <div class="w-full flex flex-col gap-1">
                                  ...
                                  <textarea name="description" rows="2" value="{{ old('description') }}" placeholder="Instrument description" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000">{{$instruments->description ?? ''}}
                                  </textarea>
                               ...
                               <div class="w-full grid xl:grid-cols-4 gap-2 p-4 ">
                                    <div class="w-full flex flex-col gap-1">
                                      ...
                                      <input type="text" name="manufacturer_name"  value="{{$instruments->purchaseInformation->manufacture_name ?? ''}}"  required placeholder="Manufacturer name" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    <div class="w-full flex flex-col gap-1">
                                      ...
                                      <input type="text" name="vendor_name"  value="{{$instruments->purchaseInformation->vendor_name ?? ''}}"  required placeholder="Vendor name" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    <div class="w-full flex flex-col gap-1">
                                      ...
                                      <input type="text" name="po_number"   value="{{$instruments->purchaseInformation->purchase_order_number ?? ''}}"  placeholder="PO number" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    <div class="w-full flex flex-col gap-1">
                                      ...
                                      <input type="date" name="purchase_date"   value="{{$instruments->purchaseInformation->purchase_date ?? ''}}"  class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    <div class="w-full flex flex-col gap-1">
                                      ...
                                      <input type="number" name="cost" placeholder="Cost"   value="{{$instruments->purchaseInformation->cost ?? ''}}"  class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                      @if ($errors->has('cost'))
                                    ...
                                    <div class="w-full flex flex-col gap-1">
                                      ...
                                      <input type="text" name="funding_source"   value="{{$instruments->purchaseInformation->funding_source ?? ''}}" placeholder="Funding source" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                ...
                                <div class="w-full xl:col-span-4 bg-primary/10 px-4 py-2 font-semibold text-primary">
                                 ...
                                 <div class="w-full grid xl:grid-cols-4 gap-2 p-4 ">
                                      <div class="w-full flex flex-col gap-1">
                                        <label class="font-semibold text-primary">Name <span class="text-danger">*</span></label>
                                        <input type="text" name="engineer_name"  value="{{$instruments->serviceengineerInformation->service_engineer_name ?? ''}}"  required placeholder="Engineer name" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    @endif
                                      ...
                                      <div class="w-full flex flex-col gap-1">
                                        ...
                                        <input type="tel" name="engineer_phone"   value="{{$instruments->serviceengineerInformation->service_engineerphone_number ?? ''}}"  placeholder="Phone number" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    @endif
                                      ...
                                      <div class="w-full flex flex-col gap-1">
                                        ...
                                        <input type="email" name="engineer_email"  value="{{$instruments->serviceengineerInformation->service_engineeremail ?? ''}}"  placeholder="Email address" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    @endif
                                      ...
                                      <div class="w-full flex flex-col gap-1">
                                        ...
                                        <input type="text" name="engineer_company" placeholder="Company name"  value="{{$instruments->serviceengineerInformation->company ?? ''}}"  class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    @endif
                                      ...
                                      <div class="w-full xl:col-span-2 flex flex-col gap-1">
                                        ...
                                        <textarea name="engineer_address" placeholder="Address" value="{{ old('engineer_address') }}" rows="2" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000">{{$instruments->serviceengineerInformation->address ?? ''}}
                                        </textarea>
                                  ...
                                  <div class="w-full xl:col-span-4 bg-primary/10 px-4 py-2 font-semibold text-primary">
                                   ...
                                   <div class="w-full grid xl:grid-cols-4 gap-2 p-4 ">
                                        <div class="w-full flex flex-col gap-1">
                                          ...
                                          <input type="date" name="manufacturing_date"  value="{{$instruments->warrantyInformation->manufacturing_date ?? ''}}" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    @endif
                                        ...
                                        <div class="w-full flex flex-col gap-1">
                                          ...
                                          <input type="date" name="installation_date"  value="{{$instruments->warrantyInformation->installation_date ?? ''}}"  class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    @endif
                                        ...
                                        <div class="w-full flex flex-col gap-1">
                                          ...
                                          <input type="number" name="warranty_period"   value="{{$instruments->warrantyInformation->warranty_period_months ?? ''}}"  placeholder="Warranty period" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                                    ...
                                    @endif
                                        ...
                                        <div class="w-full flex flex-col gap-1">
                                          ...
                                          <input type="date" name="next_service_date"   value="{{$instruments->warrantyInformation->next_service_due_date ?? ''}}" class="px-2 py-2 w-full text-sm font-medium bg-transparent placeholder-primary/70 border-[2px] border-primary/40 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] focus:ring-0 focus:outline-none focus:border-primary transition ease-in duration-2000"/>
                               ...
                               <div class="w-full flex justify-end px-4 pb-4 gap-2">
                                     <button type="submit" class="text-sm bg-success/30 px-4 py-1 rounded-[3px] rounded-tr-[8px] rounded-bl-[8px] font-semibold border-[2px] border-success/90 text-ternary hover:text-white hover:bg-success hover:border-ternary/30 transition ease-in duration-2000">Update Instrument</button>
                               </div>
                           </form>
                       </div>
