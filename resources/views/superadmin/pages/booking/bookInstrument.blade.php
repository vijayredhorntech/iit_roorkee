...
<div class="w-full flex flex-col gap-4">
    ...
    <div class="w-full grid xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 grid-cols-1 gap-4">
        ...
        <div class="w-full border-[1px] border-t-[4px] border-secondary/20 border-t-secondary bg-white flex gap-2 flex-col">
            ...
            <div class="p-4 flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="date" name="booking_date" id="booking_date" class="w-full border-[1px] border-secondary/20 rounded-md px-3 py-2 focus:outline-none focus:border-secondary">
                </div>
        ...
        <div class="w-full border-[1px] border-t-[4px] border-success/20 border-t-success bg-white flex gap-2 flex-col" id="booking_slots">
            ...
            <div class="p-4">
                <div class="grid grid-cols-4 gap-2">
                    ...
                    <div class="col-span-4"  >
                        <h3 class="font-medium text-ternary mb-2">Booked</h3>
                    ...
                    <!-- Afternoon Slots -->
                     ...
                     <div class="col-span-4 mt-4">
                        <h3 class="font-medium text-ternary mb-2">Select Time</h3>
                        <div class="grid grid-cols-4 gap-2">
                        <div>
                                <label for="select_time" class="block text-sm font-medium text-gray-700">Start Time</label>
                                <input type="time" id="select_time" name="select_time" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300">
                            </div>
                            <div>
                                <label for="end_time" class="block text-sm font-medium text-gray-700">End Time</label>
                                <input type="time" id="end_time" name="end_time" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300">
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
       ...
       //ajax when date is changed

       $("#booking_date").on("change", function() {
    var selectedDate = $(this).val();
    var instrument_id = $("#instrument_select").val();
    var container = $("#timeSlots"); // Store reference to container
    ...
    if (selectedDate) {
        $.ajax({
            ...
            success: function(response) {
                ...
                // Loop through bookings and create buttons
                response.forEach(booking => {
                    let startFormatted = formatTime(booking.start_time);
                    let endFormatted = formatTime(booking.end_time);

                    let button = `<button class="px-4 py-2 bg-danger/10 text-danger rounded cursor-not-allowed text-sm time_value">
